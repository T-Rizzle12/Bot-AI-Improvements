Msg("scriptedmode_addon BAIF\n");

BotAIFix_ScriptMode_Init <- ScriptMode_Init;
//=========================================================
...
function ScriptMode_Init( modename, mapname )
{
	...
	try
	{
		...
		bScriptedModeValid = BotAIFix_ScriptMode_Init( modename, mapname );
	}
	catch(exception)
	{
	...
	IncludeScript("botaifix");
	BotAIFix.Initialize(modename, mapname);
